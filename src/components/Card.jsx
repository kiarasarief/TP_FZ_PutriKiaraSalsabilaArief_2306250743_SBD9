  ...
  return (
    <div className="card group dark:bg-gray-800 dark:shadow-gray-700/20">
      ...
      <div className="p-5 bg-white dark:bg-gray-800">
        ...
        <button className="mt-4 text-sm font-medium text-pastel-blue hover:text-dark-pastel-blue dark:text-light-pastel-blue dark:hover:text-pastel-blue transition-colors duration-300">
          Read More
        </button>
      </div>
    </div>
